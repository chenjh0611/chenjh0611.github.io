    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          //var minSrc = 'http://code.skyheng.com/ins-min/' + data.link[i] + '.min.jpg';
		  var minSrc = 'http://code.skyheng.com/ins/' + data.link[i] + '.jpg'; // 我自己修改后
          var src = 'http://code.skyheng.com/ins/' + data.link[i];
